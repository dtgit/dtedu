...
class FeedbackForm(AddForm):
    ...
    label = u'Feedback'
    description = u'Thank you for contacting Teachers Without Borders. Please complete the form below and a TWB staff member will contact you shortly.'
    ...
    def action_submit(self, action, data):
        ...
        router = {'Membership' : 'heather@teacherswithoutborders.org',
                  'Partnership' : 'vvorres@cisco.com',
                  'Internship' : 'heather@teacherswithoutborders.org',
                  'Program' : 'haviva@teacherswithoutborders.org',
                  'Courses' : 'haviva@teacherswithoutborders.org',
                  'Website' : 'syazdani@cisco.com', 
                  'Donations'  : 'amy@teacherswithoutborders.org',
                  'Other' : 'general@teacherswithoutborders.org'
                }
