...
class Renderer(base.Renderer):
    ...
    def getNavObjects(self):
        ...
        if self.isCourseObject():
            ...
            #get Ploneboard object
            bpath = '/'.join(self.ecparent.getPhysicalPath())+'/'
            bbrain = self.ecparent.portal_catalog.searchResults(path=bpath, Type='Message Board')
    ...
    def isSelected(self, item):
        ...
        if item.getURL() == self.context.absolute_url():
